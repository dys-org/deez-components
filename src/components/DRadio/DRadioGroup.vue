    ...
    >
      <div v-for="opt in props.options" :key="opt.id" class="flex items-center">
        <input
          ...
          :name="props.name"
          type="radio"
          class="form-radio size-4 border-gray-300 text-primary-500 focus:ring-primary-500 dark:border-white/30 dark:bg-white/5 dark:ring-offset-gray-800 dark:checked:border-current dark:checked:bg-current"
        />
